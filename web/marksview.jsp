...
<html>
    <head>
        ...
        <title>Teacher marks view-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left p-2">
                    <h1 style="color:aqua">Please enter userid and student name</h1>
                    <form action="studchk.jsp" method="post">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 text-center">
                                <button class="btn btn-primary" type="submit">VIEW MARKS</button>
                            </div>
                        </div>
                    </form>
                </div>    
