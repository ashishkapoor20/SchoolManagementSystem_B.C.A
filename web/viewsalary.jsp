...
<html>
    <head>
        ...
        <title>Admin view salary-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-md-6 text-left p-2">
                    <%
                        try
                        {
                            String u,n,m,p,a,d,na,i;
                            i=(String)session.getAttribute("i");
                            na=(String)session.getAttribute("n");
                            %>
                            <h1 style="color: aqua"><i>Salary For <%=na%></i></h1>
                            <%
                            Class.forName("org.apache.derby.jdbc.ClientDriver");
                            Connection cn= DriverManager.getConnection("jdbc:derby://localhost:1527/cllg_project");
                            PreparedStatement ps= cn.prepareStatement("select * from salary where userid=? and name=?");  
                            ps.setString(1,i);
                            ps.setString(2,na);
