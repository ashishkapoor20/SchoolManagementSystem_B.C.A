...
<html>
    <head>
        ...
        <title>Teacher add marks-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        if (rs.next()) {
                                            ...
                                            out.print("<a href='teacherchangepass.jsp' class='dropdown-item'>Change Password</a>");
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left p-2">
                    <h2 style="color: rgba(0, 181, 204, 1)"><i>Add Marks</i></h2>
                    <form action="chkstudmark.jsp" method="post">
                        <div class="form-row">
                            <div class="form-group col-4">
                                USERID *
                            </div>
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="UserID *" name="uid" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="Name *" name="unm" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="CourseID *" name="ci" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="Course *" name="co" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="Marks *" name="ma" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="Semester *" name="se" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="Peirod *" name="pe" required="">
                            </div>
                        </div>
                        <div class="form-row">
                ...
                <div class="col-md-6 text-center">
                    <img src="images/addmark.png" class="img-fluid">
                </div>
            </div>
        </div>
        <br>
