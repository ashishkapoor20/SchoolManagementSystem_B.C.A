...
<html>
    <head>
        ...
        <title>Admin new student entry-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center">
                    <h2 style="color: rgba(0, 181, 204, 1)"><i>New Student Entry</i></h2>
                    <br>
                    <form action="studentdbentry.jsp" method="post">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-8">
                                <input type="text" class="form-control" name="uco" placeholder="only for students" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                ...
                <div class="col-md-6 text-center pt-5">
                    <img src="images/addstudent.png" class="img-fluid">
                </div>
            </div>
        </div>
        <!--full footer-->
