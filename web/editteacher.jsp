...
<html>
    <head>
        ...
        <title>Admin edit/view teacher-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <%
            ...
            try {
                ...
                if(rs.next())
                {
                    ...
                    %>
                        <form action="vieweditteacher.jsp" method="post">
                        <div class="form-row">
                ...
                else
                {
                    ...
                    <a href="teacheredit.jsp" style="color: black">click to go to view teacher edit page</a>
                    <%
                }
                cn.close();
            } catch (Exception ex) {
