...
<html>
    <head>
        ...
        <title>Teacher BCA report-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                ...
                <div class="col-md-6 text-left p-2">
                    ...
                    <%
                        try
                        {
                            ...
                            PreparedStatement ps= cn.prepareStatement("select * from marks where course='bca'");                
