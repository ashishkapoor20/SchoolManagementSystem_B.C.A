...
<html>
    <head>
        ...
        <title>Admin home-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        session.setAttribute("pa", rs1.getString("password"));
                                        session.setAttribute("nm", rs1.getString("name"));
                                        session.setAttribute("mail", rs1.getString("email"));
                                        session.setAttribute("reg", rs1.getString("reg_date"));
                                        session.setAttribute("ut", rs1.getString("type"));
                                        cn3.close();
                                    } catch (Exception ex) {
                                        out.println(ex);
                                    }
