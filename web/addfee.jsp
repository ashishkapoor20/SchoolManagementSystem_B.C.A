...
<html>
    <head>
        ...
        <title>Admin add fee-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left p-2">
                    <form action="feeindb.jsp" method="post">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="Course *" name="uc" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="Recieve Date *" name="rd" required="">
                            </div>
                        </div>
                        <div class="form-row">
                ...
                <div class="col-md-6 text-center">
                    <img src="images/fees.png" class="img-fluid">
                </div>
            </div>
        </div>
        <!--form ends here-->
