...
<html>
    <head>
        ...
        <title>Admin edit/view my profile-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
    ...
    <body>
        ...
        <%
            String uidd = (String) session.getAttribute("user_id");
            String unmm = (String) session.getAttribute("nm");
            ...
            try {
                ...
                if(rs.next())
                {
                    ...
                    %>
                        <form action="vieweditprofile.jsp" method="post">
                        <div class="form-row">
