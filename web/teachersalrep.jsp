...
<html>
    <head>
        ...
        <title>Teacher salary report-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left p-2">
                    <h1>Salary Report for <%=name%></h1>
                    <%
                        try
                        {
                            String nam=(String)session.getAttribute("user_id");
                            String u,n,m,p,a,d;
                            Class.forName("org.apache.derby.jdbc.ClientDriver");
                            Connection cn= DriverManager.getConnection("jdbc:derby://localhost:1527/cllg_project");
                            PreparedStatement ps= cn.prepareStatement("select * from salary where userid=?");   
                            ps.setString(1,nam);
