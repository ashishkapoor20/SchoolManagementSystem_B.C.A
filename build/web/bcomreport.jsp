...
<html>
    <head>
        ...
        <title>Admin BCOM report-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                ...
                <div class="col-md-6 text-left p-2">
                    ...
                    <%
                        try
                        {
                            ...
                            PreparedStatement ps= cn.prepareStatement("select * from fees where course='bcom'");                
