            ...
            try {
                ...
                if(rs.next())
                {
                    ...
                    <div class="card bg-danger text-white">
                        <div class="card-body"><h1>This teacher already exist please go back and enter new entry</h1></div>
                    </div>
                    <a href="teacherentry.jsp" style="color: black">click to go to teacher entry page</a>
                    <%
                }
                else
                {
                    ...
                    if(n>0)
                    {
                        %>
                            <div class="card bg-success text-white">
                                <div class="card-body"><h1>New Teacher Added Successfully</h1></div>
                            </div>
