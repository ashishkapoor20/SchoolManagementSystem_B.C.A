        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left p-2">
                    <h1 style="color:aqua">Please enter userid and teacher name</h1>
                    <form action="chkteacher.jsp" method="post">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 text-center">
                                <button class="btn btn-primary" type="submit">VIEW SALARY</button>
                            </div>
                        </div>
                    </form>
                </div>    
