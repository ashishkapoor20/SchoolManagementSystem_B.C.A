...
<html>
    <head>
        ...
        <title>Teacher marks report-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left p-2">
                    <h2 style="color: aqua"><i>Please select the desired course for marks report</i></h2>
                    <form action="checkcourse.jsp" method="post">
                        <div class="form-row">
