<%-- 
    Document   : fbjsp
    Created on : Jun 26, 2019, 4:04:31 PM
    Author     : admin
--%>
...
<html>
    <head>
        ...
        <title>Feedback-Student Management System</title>
                    ...
                    <nav class="navbar navbar-dark bg-dark navbar-expand-md">
                        ...
                        <div class="collapse navbar-collapse" id="navbarToggler">
                            <ul class="navbar-nav">
                                ...
                                <li class="navbar-item dropdown">
                                    <a href="#" class="navbar-link dropdown-toggle" data-toggle="dropdown" role="button">Login</a> &nbsp;  &nbsp;  &nbsp;
                                    <div class="dropdown-menu">
                                        <a href="loginadmin.html" class="dropdown-item">Login As Admin</a>
                                        <a href="loginteacher.html" class="dropdown-item">Login As Faculty/Teacher</a>
                                        <a href="loginstudent.html" class="dropdown-item">Login As Student</a> 
                                    </div>
                                </li>

                                <li class="navbar-item dropdown">
                                    <a href="#" class="navbar-link dropdown-toggle" data-toggle="dropdown" role="button">Register</a> &nbsp;  &nbsp;  &nbsp;
                                    <div class="dropdown-menu">
                                        <a href="#" class="dropdown-item">Register As Admin</a>
                                        <a href="#" class="dropdown-item">Register As Faculty/Teacher</a>
                                        <a href="#" class="dropdown-item">Register As Student</a>
                                    </div>
                                </li>
                                <li class="navbar-item">
            ...
            <div class="row">
                <div class="col-md-12 p-2 text-center">
                    <%
                        ...
                        String feedback = request.getParameter("ufb");
                        try {
                            Class.forName("org.apache.derby.jdbc.ClientDriver");
                            Connection cn = DriverManager.getConnection("jdbc:derby://localhost:1527/cllg_project");
                            PreparedStatement ps = cn.prepareStatement("insert into feed values(?,?,?)");
                            ps.setString(1, nm);
                            ps.setString(2, email);
                            ps.setString(3, feedback);
                            ps.executeUpdate();
                            out.println("<h2 style='color:green'><i>Thank you for your feedback your feedback has been submitted.<i/></h2>");
                            cn.close();
                        } catch (Exception ex) {
                            out.println(ex);
                        }
