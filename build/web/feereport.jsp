...
<html>
    <head>
        ...
        <title>Admin fee report-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left p-2">
                    <h2 style="color: aqua"><i>Please select the desired course for fees report</i></h2>
                    <form action="chkcourse.jsp" method="post">
                        <div class="form-row">
                            <div class="form-group col-4">
                                COURSE *
                            </div>
                            <div class="form-group col-8">
                                <input type="radio" name="course" value="bca" checked=""> BCA<br>
