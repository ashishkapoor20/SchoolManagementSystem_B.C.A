...
<html>
    <head>
        ...
        <title>Admin view all students-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-left p-2">
                    <h1 style="color:aqua">List of all Students Studying</h1>
                    <%
                        try
                        {
                            String u,n,e,r,a,c;
                            ...
                            PreparedStatement ps= cn.prepareStatement("select userid,name,email,reg_date,address,course from login where type='student'");
