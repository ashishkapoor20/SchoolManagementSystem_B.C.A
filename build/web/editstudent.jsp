...
<html>
    <head>
        ...
        <title>Admin edit/view student-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
    ...
    <body>
                        ...
                        <div class="collapse navbar-collapse" id="navbarToggler">
                            <ul class="navbar-nav">
                                ...
                                <li class="navbar-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="teacherview.jsp" class="dropdown-item">View All Teacher</a>
                                        <a href="teacheredit.jsp" class="dropdown-item">View/Edit Teacher Profile</a>
                                    </div>
                                </li>
        ...
        <%
            ...
            String tn = request.getParameter("unm");
            try {
                Class.forName("org.apache.derby.jdbc.ClientDriver");
                Connection cn = DriverManager.getConnection("jdbc:derby://localhost:1527/cllg_project");
                PreparedStatement ps = cn.prepareStatement("select userid,name,email,reg_date,address from login where userid=? and name=?");
                ps.setString(1, u);
                ps.setString(2, tn);
                ...
                if(rs.next())
                {
                    ...
                    %>
                        <form action="vieweditstudent.jsp" method="post">
                        <div class="form-row">
                            <div class="form-group col-4">
                                USERID *
                            </div>
                            <div class="form-group col-8">
                                <input type="text" class="form-control" value="<%=i%>" name="uid">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" value="<%=n%>" name="unm">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" value="<%=e%>" name="em">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" value="<%=reg%>" name="rd" readonly="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" value="<%=add%>" name="ad">
                            </div>
                        </div>
                        <div class="form-row">
                ...
                else
                {
                    ...
                    <a href="studentedit.jsp" style="color: black">click to go to view student edit page</a>
                    <%
                }
                cn.close();
            } catch (Exception ex) {
        ...
        <!--form code starts here-->
                ...
                <div class="col-md-6 text-center">
                    <img src="images/allteacher.png" class="img-fluid">
                </div>
            </div>
        </div>
        <!--form ends here-->
