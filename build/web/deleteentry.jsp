...
<html>
    <head>
        ...
        <title>Admin delete entry-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                        ...
                        <div class="collapse navbar-collapse" id="navbarToggler">
                            <ul class="navbar-nav">
                                ...
                                <li class="navbar-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="#" class="dropdown-item">Add Fees</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center">
                    <h2 style="color: rgba(0, 181, 204, 1)"><i>Delete Entry</i></h2>
                    <br>
                    <form action="delete.jsp" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-8">
                                <input type="text" class="form-control" name="utp" required="">
                            </div>
                        </div>
                        <div class="form-row">
