...
<html>
    <head>
        ...
        <title>Admin new teacher entry-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="navbar-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="#" class="dropdown-item">Fees Report</a>
                                        <a href="#" class="dropdown-item">View Fees</a>
                                    </div>
                                </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center">
                    <h2 style="color: rgba(0, 181, 204, 1)"><i>New Teacher Entry</i></h2>
                    <br>
                    <form action="teacherdbentry.jsp" method="post">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-8">
                                <input type="email" class="form-control" name="umail" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-8">
                                <input type="text" class="form-control" name="urg" placeholder="in (yyyy-mm-dd)" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-8">
                                <input type="text" class="form-control" name="uco" placeholder="only for students">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-8">
                                <textarea class="form-control" rows="3" name="uad" required=""></textarea>
                            </div>
                        </div>
                        <div class="form-row">
                ...
                <div class="col-md-6 text-center pt-5">
                    <img src="images/addteacher.jpg" class="img-fluid">
                </div>
            </div>
        </div>
        <!--full footer-->
