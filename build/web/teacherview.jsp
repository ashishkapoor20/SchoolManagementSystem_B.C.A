...
<html>
    <head>
        ...
        <title>Admin view all teachers-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-left p-2">
                    <h1 style="color:aqua">List of all Teachers employed</h1>
                    <%
                        try
                        {
                            String u,n,e,r,a;
                            ...
                            PreparedStatement ps= cn.prepareStatement("select userid,name,email,reg_date,address from login where type='teacher'");
