<%-- 
    Document   : contactus
    Created on : Jun 28, 2019, 7:46:18 PM
    Author     : admin
--%>
    ...
    <body>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <i>we are always there to help. If you have any requirements/queries about our services: fill up the contact us form below and we'll do our best to reply within 24hour alternatively simply picup the phone give us a call.</i>
                        <hr width="900px">                
                    </div>
                </div>
            </div>
        ...
        <%
            String fn, em, cn, sb, msg;
            fn = request.getParameter("uname");
            em = request.getParameter("umail");
            cn = request.getParameter("ucn");
            sb = request.getParameter("subject");
            msg = request.getParameter("message");
            try {
                Class.forName("org.apache.derby.jdbc.ClientDriver");
                Connection cn1 = DriverManager.getConnection("jdbc:derby://localhost:1527/cllg_project");
                PreparedStatement ps1 = cn1.prepareStatement("insert into contactus values(?,?,?,?,?)");
                ps1.setString(1, fn);
                ps1.setString(2, em);
                ps1.setString(3, cn);
                ps1.setString(4, sb);
                ps1.setString(5, msg);
                ps1.executeUpdate();
                out.println("<h2 style='color:green' class='text-center p-3'><i>Thank you for your contacting us. we will contact you as soon as possible<i/></h2>");
                cn1.close();
            } catch (Exception ex) {
                out.println(ex);
            }
        ...
        <section>
            <div class="container-fluid">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3500.363908505044!2d77.31352111441888!3d28.678758882399602!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd5a6423c64f%3A0x55e45e087df12b26!2sArwachin+International+School!5e0!3m2!1sen!2sin!4v1561137530905!5m2!1sen!2sin" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
        </section>
        <!--full footer-->
