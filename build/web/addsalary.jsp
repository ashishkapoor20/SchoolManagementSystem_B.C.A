...
<html>
    <head>
        ...
        <title>Admin add salary-Student Management System</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left p-2">
                    <form action="salaryindb.jsp" method="post">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="Month *" name="mo" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="Amount *" name="am" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-8">
                                <input type="text" class="form-control" placeholder="Date *" name="da" required="">
                            </div>
                        </div>
                        <div class="form-row">
                ...
                <div class="col-md-6 text-center">
                    <img src="images/salary.png" class="img-fluid">
                </div>
            </div>
        </div>
        <!--form ends here-->
